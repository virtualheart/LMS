...
<html>
	...
	<body>
		...
		<div class="col-md-9" style="padding-left:80px; width: 1300px;">
			...
			<?php
				$qry="select sbb.sid,sbb.bid,sbb.request_date,sbb.role,sb.bno,sb.bcode,sb.title,sb.aname,sb.publication from barrow_books_history sbb join books sb on sb.bid = sbb.bid where sid='{$_SESSION["sid"]}' and role='staff'";
				//echo $qry;
				$res=$con->query($qry);
				if($res->num_rows>0)
				{
